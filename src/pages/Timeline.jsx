...
const Timeline = () => {
    return (<>
            ...
            <div className={'relative bg-background-900'}>
                <div className={'absolute mx-auto h-full w-full z-10 max-sm:hidden'}>
                ...
                <div className={'absolute h-64 sm:bg-gradient-to-t from-zinc-900 to-transparent w-full bottom-0 z-20'}>
