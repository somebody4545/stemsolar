                ...
                <div className={"max-w-screen-lg mx-auto"}>
                    <div className={'flex flex-col-reverse md:flex-row items-center'}>
                        <div className={'w-full md:w-1/2 p-4'}>
                            <h2 className={'text-4xl font-bold pb-2'}>Expand Renewable Energy Advocacy to More
                                Schools</h2>
                        ...
                        <div className={'w-full md:w-1/2 p-4 aspect-square'}>
                            <img src="/outreach.png" alt="Schools"
                    ...
                    <div className={'flex flex-col-reverse md:flex-row-reverse items-center'}>
                        ...
                        <div className={'w-full md:w-1/2 p-4'}>
                            <img src="/washington.png" alt="Future Plans"
                                 className={'object-cover h-full w-full rounded-lg overflow-hidden'}/>
                        </div>
                    </div>
                    <div className={'flex flex-col-reverse md:flex-row items-center'}>
                        <div className={'w-full md:w-1/2 p-4'}>
                            <h2 className={'text-4xl font-bold pb-2'}>Develop a Student Led Sustainability
                                Curriculum</h2>
                        ...
                        <div className={'w-full md:w-1/2 p-4'}>
                            <img src="/curriculum.jpg" alt="Future Plans"
                                 className={'object-cover h-full w-full rounded-lg overflow-hidden'}/>
                        </div>
                    </div>
                </div>
